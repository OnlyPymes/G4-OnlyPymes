...
<body>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block"
      ...
      <div class="container"><a class="navbar-brand d-inline-flex" href="index_registrado.php"><img class="d-inline-block"
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0">
          ...
          <form class="d-flex">
            ...
            <a class="text-negrita-titulos" href="./HTML/iniciarsesion.php">
              <img src="https://img.icons8.com/windows/32/000000/shop.png" width="18" height="18"/></a><a class="text-negrita-titulos" href="#!">
            </a>
            <a href="./HTML/cerrarsesion.php">Cerrar Sesion</a>
          </form>
        </div>
      </div>
    </nav>
        ...
        <div class="row flex-center">
          <div class="col-12 mb-10">
            <div class="d-flex align-items-center flex-column">
              <h1 class="fw-normal">Bienvenido 
                <?php
                  echo $nombre;
                ?>
                 tenemos : Vendedores como tú, para gente como tú</h1>
                  ...
                  <div class="row h-100 align-items-center g-2">
                    <div class="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                      <div class="card card-span h-100 text-white"><img class="img-fluid h-100"
                        ...
                        </div><a class="stretched-link" href="HTML/productos/productos.php?id_pr=1&foto=pantunflas&nombre=$nombre"></a>
                      </div>
                    </div>
                    <!-- MANJAR DE CAMPO -->

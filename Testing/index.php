  ...
  <main>
    <section class="acerca-de">
      <div class="contenedor">
        <a href="paginasWeb/registro.php" class="Boton">Registrarse</a>
        <a href="paginasWeb/ingresar.php" class="Boton">Ingresar</a>
        <a href="paginasWeb/formulario_imagenes.php" class="Boton">Imagenes</a>
        ...
        <a href="paginasWeb/menu_principal.php" class="boton">Saber mas</a>
      </div>
    </section>
